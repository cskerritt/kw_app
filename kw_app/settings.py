"""
Django settings for KW LCP App project.
...
SECRET_KEY = env("SECRET_KEY", default="django-insecure-9dzfiXSlF2Y8XfNcHWkmJowxpDSOUcsMgdKhVL5a")
...
WSGI_APPLICATION = "kw_app.wsgi.application"
...
if "DATABASE_URL" in env:
    ...
    DATABASES = {
        "default": {
            ...
            "NAME": env("DJANGO_DATABASE_NAME", default="kw_app"),
...
LANGUAGE_CODE = "en-us"
LANGUAGE_COOKIE_NAME = "kw_app_language"
LANGUAGES = [
...
EMAIL_SUBJECT_PREFIX = "[KW LCP App] "
...
LOGGING = {
    ...
    "loggers": {
        ...
        "kw_app": {
            "handlers": ["console"],
            "level": env("KW_APP_LOG_LEVEL", default="INFO"),
        },
    },
}
